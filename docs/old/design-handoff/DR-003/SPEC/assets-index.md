...
Delivered as **`assets/icons/klytos-ui-icons.svg`** — one SVG sprite, **arrow_forward,arrow_upward,auto_awesome,backup,block,check,check_circle,chevron_right,close,cloud_off,cloud_upload,construction,content_copy,dashboard_customize,data_object,delete,description,devices,drag_indicator,edit,edit_note,error,expand_less,expand_more,extension,fingerprint,folder,format_align_left,gavel,help,imagesmode,key,key_off,lock,logout,mail,more_horiz,pending,phonelink_lock,play_circle,priority_high,progress_activity,public,rule,schedule,search,search_off,sell,shield_lock,shield_question,smart_toy,stop,sync_problem,system_update_alt,task_alt,terminal,title,toll,tune,unfold_more,verified,verified_user,visibility,vpn_key,warning,webhook,widgets `<symbol>`
elements**, one per glyph the design uses. Line icons on the Material Symbols Outlined 24
...
The design uses **arrow_forward,arrow_upward,auto_awesome,backup,block,check,check_circle,chevron_right,close,cloud_off,cloud_upload,construction,content_copy,dashboard_customize,data_object,delete,description,devices,drag_indicator,edit,edit_note,error,expand_less,expand_more,extension,fingerprint,folder,format_align_left,gavel,help,imagesmode,key,key_off,lock,logout,mail,more_horiz,pending,phonelink_lock,play_circle,priority_high,progress_activity,public,rule,schedule,search,search_off,sell,shield_lock,shield_question,smart_toy,stop,sync_problem,system_update_alt,task_alt,terminal,title,toll,tune,unfold_more,verified,verified_user,visibility,vpn_key,warning,webhook,widgets unique glyphs**. Shell glyphs (`chevron_right`, `logout`,
...
```
arrow_forward         arrow_upward          auto_awesome          backup                block\ncheck                 check_circle          chevron_right         close                 cloud_off\ncloud_upload          construction          content_copy          dashboard_customize   data_object\ndelete                description           devices               drag_indicator        edit\nedit_note             error                 expand_less           expand_more           extension\nfingerprint           folder                format_align_left     gavel                 help\nimagesmode            key                   key_off               lock                  logout\nmail                  more_horiz            pending               phonelink_lock        play_circle\npriority_high         progress_activity     public                rule                  schedule\nsearch                search_off            sell                  shield_lock           shield_question\nsmart_toy             stop                  sync_problem          system_update_alt     task_alt\nterminal              title                 toll                  tune                  unfold_more\nverified              verified_user         visibility            vpn_key               warning\nwebhook               widgets
```
