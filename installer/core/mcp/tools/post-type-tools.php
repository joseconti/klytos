...
function registerPostTypeTools(ToolRegistry $registry): void
{
    ...
    $registry->register(
        ...
        [
            ...
            'editor'     => ['type' => 'string', 'description' => 'Content editor for this post type. "gutenberg" (default) = block editor with visual blocks and wp:html for free HTML, best for pages with rich visual layouts. "tinymce" = classic WYSIWYG editor, simpler, best for structured content with many custom fields. ALWAYS ask the user which they prefer.', 'enum' => ['gutenberg', 'tinymce']],
