...
<form method="get" style="display:flex;gap:0.5rem;margin-bottom:1rem;flex-wrap:wrap;align-items:flex-end;">
    ...
    <a href="?form_id=<?php echo urlencode( $formId ); ?>" class="btn btn-sm btn-outline">Limpiar</a>
</form>
...
<?php else: ?>
    ...
    <div style="display:flex;justify-content:center;gap:0.25rem;margin-top:1rem;">
        ...
        ?>
            <a href="?<?php echo http_build_query( $params ); ?>" class="btn btn-sm <?php echo $isCurrentPage ? 'btn-primary' : 'btn-outline'; ?>">
                <?php echo $p; ?>
            </a>
        <?php endfor; ?>
    </div>
