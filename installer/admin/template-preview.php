...
<div style="margin-bottom:1rem;">
    <a href="templates.php" style="color:var(--admin-primary);text-decoration:none;">&larr; <?php echo __( 'design.templates' ); ?></a>
</div>
    ...
    <div style="display:grid;grid-template-columns:250px 1fr;gap:1.5rem;align-items:start;">
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:0;">
                <p style="padding:0.75rem 1rem;color:var(--admin-text-muted);font-size:0.85rem;margin:0;border-bottom:1px solid var(--admin-border);">
                    <?php echo klytos_esc_html( $template['description'] ?? '' ); ?>
                </p>
                <div style="padding:0.5rem;">
                    <?php foreach ( $structure as $i => $blockRef ): ?>
                        <?php $bid = $blockRef['block_id'] ?? ''; ?>
                        <div style="display:flex;align-items:center;gap:0.5rem;padding:0.5rem 0.75rem;border-radius:4px;margin-bottom:2px;background:var(--admin-bg);">
                            <span style="color:var(--admin-text-muted);font-size:0.75rem;width:1.5rem;text-align:center;"><?php echo $i + 1; ?></span>
                            <code style="font-size:0.8rem;"><?php echo klytos_esc_html( $bid ); ?></code>
                        </div>
                    <?php endforeach; ?>
                </div>
                <div style="padding:0.75rem 1rem;border-top:1px solid var(--admin-border);">
                    ...
                    <span style="color:var(--admin-text-muted);font-size:0.8rem;margin-left:0.5rem;">
