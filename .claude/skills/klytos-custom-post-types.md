...
description: Guide for creating Custom Post Types, Taxonomies, and Custom Fields in Klytos CMS. Use when adding new content types beyond pages.
trigger: When the user needs to create custom content types (products, properties, blog posts, etc.), add taxonomies, or define structured custom fields.
---
