...
description: Complete guide for escape and sanitization functions in Klytos CMS. Use when outputting data to HTML, processing user input, filtering HTML content, or implementing CSRF protection.
trigger: When the user needs to escape output, sanitize input, filter HTML, validate data, or protect forms against CSRF in Klytos.
---
