...
description: Guide for scheduling background tasks, cron jobs, and recurring actions in Klytos CMS. Use when a plugin needs to run tasks on a schedule.
trigger: When the user needs to schedule background tasks, create cron jobs, run periodic cleanup, or execute deferred actions.
---
