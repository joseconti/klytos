...
description: Guide for adding items to the admin sidebar, creating admin pages for plugins, and building admin UI in Klytos CMS.
trigger: When the user needs to add menu items to the admin panel sidebar, create admin pages for plugins, build forms, or understand the admin panel structure.
---
