...
description: Complete reference for page data structure, creation, editing, and templates in Klytos CMS. Use when creating, updating, or querying pages via code, MCP, or admin.
trigger: When the user needs to create pages, understand page fields, use templates, work with hierarchical URLs, or manage page content in Klytos.
---
